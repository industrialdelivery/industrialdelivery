		...
		<fieldset>
			...
			<div id="opc_account_choice">
				<div class="opc_float">
					...
					<p>
						<input type="button" class="exclusive_large btn" id="opc_guestCheckout" value="{l s='Guest checkout'}" />
					</p>
				</div>
			...
			<div id="opc_account_form">
				...
				<div class="radio required control-group">
					...
					{foreach from=$genders key=k item=gender}
						...
						<label for="id_gender{$gender->id_gender}" class="top help-inline">{$gender->name}</label>
					{/foreach}
					</div>
				</div>
				<div class="required text control-group">
				...
				{if isset($one_phone_at_least) && $one_phone_at_least}
					<p class="inline-infos required is_customer_param">{l s='You must register at least one phone number.'} <sup>*</sup></p>
				{/if}								
				...
				<div class="checkbox is_customer_param controls">
				...
				<div id="opc_invoice_address" class="is_customer_param">
					...
					{if isset($one_phone_at_least) && $one_phone_at_least}
						<p class="inline-infos required">{l s='You must register at least one phone number.'} <sup>*</sup></p>
					{/if}					
					<div class="text control-group">
						<label for="phone_invoice" class="control-label">{l s='Home phone'}</label>
						<div class="controls">
							<input type="text" class="text" name="phone_invoice" id="phone_invoice" value="" />
						</div>
					</div>
					<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}text is_customer_param control-group">
						<label for="phone_mobile_invoice" class="control-label">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least}{/if}</label>
						<div class="controls">
				...
				<p class="submit">
					<input type="submit" class="exclusive btn button" name="submitAccount" id="submitAccount" value="{l s='Save'}" />
				</p>
