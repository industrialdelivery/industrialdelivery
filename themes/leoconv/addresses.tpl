...
<div class="addresses">
	...
	<div class="bloc_adresses clearfix row-fluid">
	{foreach from=$multipleAddresses item=address name=myLoop}
	<div class="span6">
		<ul class="row-fluid address {if $smarty.foreach.myLoop.last}last_item{elseif $smarty.foreach.myLoop.first}first_item{/if} {if $smarty.foreach.myLoop.index % 2}alternate_item{else}item{/if}">
...
<div class="clear address_add"><a href="{$link->getPageLink('address', true)}" title="{l s='Add an address'}" class="button_large btn">{l s='Add an address'}</a></div>
