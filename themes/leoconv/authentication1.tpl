...
<form action="{$link->getPageLink('authentication', true)}" method="post" id="account-creation_form" class="std form-horizontal">
	...
	<fieldset class="account_creation">
        ...
        <div class="control-group">
            ...
            <div class="controls">
			{foreach from=$genders key=k item=gender}
				<label class="radio" for="id_gender{$gender->id}" class="top">
                    <input type="radio" name="id_gender" id="id_gender{$gender->id}" value="{$gender->id}" {if isset($smarty.post.id_gender) && $smarty.post.id_gender == $gender->id}checked="checked"{/if} />
                    {$gender->name}
                </label>
			{/foreach}
		...
		<div class="control-group">
			...
			<div class="controls">
                <input onkeyup="$('#firstname').val(this.value);" type="text" class="text input-xlarge" id="customer_firstname" name="customer_firstname" value="{if isset($smarty.post.customer_firstname)}{$smarty.post.customer_firstname}{/if}" />
            </div>
		</div>
        <div class="control-group">
			<label for="customer_lastname" class="control-label">{l s='Last name'} <sup>*</sup></label>
            <div class="controls">
			    <input onkeyup="$('#lastname').val(this.value);" type="text" class="text input-xlarge" id="customer_lastname" name="customer_lastname" value="{if isset($smarty.post.customer_lastname)}{$smarty.post.customer_lastname}{/if}" />
            </div>
		</div>
        <div class="control-group">
			<label for="email" class="control-label">{l s='E-mail'} <sup>*</sup></label>
            <div class="controls">
			    <input type="text" class="text input-xlarge" id="email" name="email" value="{if isset($smarty.post.email)}{$smarty.post.email}{/if}" />
            </div>
		</div>
        <div class="control-group">
			<label class="control-label" for="passwd">{l s='Password'} <sup>*</sup></label>
            <div class="controls">
                <input type="password" class="text input-xlarge" name="passwd" id="passwd" />
