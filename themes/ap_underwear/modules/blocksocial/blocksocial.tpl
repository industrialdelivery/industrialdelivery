...
<div id="social_block" class="block">
	 <div class="block_content">	 	
		...
		{if isset($facebook_url) && $facebook_url != ''}
			<li class="facebook">
				<a class="_blank btn-tooltip" href="{$facebook_url|escape:html:'UTF-8'}">
		...
		{if isset($twitter_url) && $twitter_url != ''}
			<li class="twitter">
				<a class="_blank btn-tooltip" href="{$twitter_url|escape:html:'UTF-8'}">
		...
		{if isset($rss_url) && $rss_url != ''}
			<li class="rss">
				<a class="_blank btn-tooltip" href="{$rss_url|escape:html:'UTF-8'}">
        ...
        {if isset($youtube_url) && $youtube_url != ''}
        	<li class="youtube">
        		<a class="_blank btn-tooltip" href="{$youtube_url|escape:html:'UTF-8'}">
        ...
        {if isset($google_plus_url) && $google_plus_url != ''}
        	<li class="google-plus">
        		<a class="_blank btn-tooltip" href="{$google_plus_url|escape:html:'UTF-8'}">
        ...
        {if isset($pinterest_url) && $pinterest_url != ''}
        	<li class="pinterest">
        		<a class="_blank btn-tooltip" href="{$pinterest_url|escape:html:'UTF-8'}">
        ...
        {if isset($vimeo_url) && $vimeo_url != ''}
        	<li class="vimeo">
        		<a class="_blank btn-tooltip" href="{$vimeo_url|escape:html:'UTF-8'}">
        ...
        {if isset($instagram_url) && $instagram_url != ''}
        	<li class="instagram">
        		<a class="_blank btn-tooltip" href="{$instagram_url|escape:html:'UTF-8'}">
