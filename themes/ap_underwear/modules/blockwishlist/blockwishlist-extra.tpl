...
{else}
	{foreach name=wl from=$wishlists item=wishlist}
		...
		<p class="buttons_bottom_block">
			<a class="btn btn-default wishlist_button" tabindex="0" data-toggle="popover" data-trigger="focus" title="{l s='Wishlist' mod='blockwishlist'}" data-placement="bottom" id="wishlist_button">{l s='Add to wishlist' mod='blockwishlist'}</a></p>
