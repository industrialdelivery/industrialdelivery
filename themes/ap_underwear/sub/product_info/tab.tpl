											...
											<div class="left-block">
												<div class="product-image-container image ImageWrapper">
													<a href="{$accessoryLink|escape:'html':'UTF-8'}" title="{$accessory.legend|escape:'html':'UTF-8'}" class="product-image product_image">
														<img class="lazyOwl" src="{$link->getImageLink($accessory.link_rewrite, $accessory.id_image, 'under_home_default')|escape:'html':'UTF-8'}" alt="{$accessory.legend|escape:'html':'UTF-8'}" />
													</a>
													<div class="Buttons StyleC">
														{if isset($quick_view) && $quick_view}
															<a class="quick-view btn btn-inverse" href="{$accessory.link|escape:'html':'UTF-8'}" data-link="{$accessory.link|escape:'html':'UTF-8'}" data-original-title="{l s='Quick view'}">
												...
												<div class="product-meta">	
													...
													<div class="functional-buttons clearfix">	
														{if !$PS_CATALOG_MODE && ($accessory.allow_oosp || $accessory.quantity > 0)}
																<a class="exclusive cart button ajax_add_to_cart_button btn" href="{$link->getPageLink('cart', true, NULL, "qty=1&amp;id_product={$accessory.id_product|intval}&amp;token={$static_token}&amp;add")|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product|intval}" title="{l s='Add to cart'}">
														...
														{if isset($comparator_max_item) && $comparator_max_item}				
															<a class="add_to_compare compare  btn btn-outline" href="{$accessory.link|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product}" title="{l s='Add to compare'}" >
