        ...
        <li class="clearfix media">
            ...
            <div class="product-block">
				...
				<div class="product-container media" itemscope itemtype="https://schema.org/Product">
                 <a class="products-block-image img pull-left" href="{$product->product_link|escape:'html'}" title="{$product->legend|escape:html:'UTF-8'}"><img class="replace-2x img-responsive" src="{$link->getImageLink($product->link_rewrite, $product->id_image, 'under_small_default')|escape:'html'}" alt="{$product->name|escape:html:'UTF-8'}" itemprop="image" />
                 </a>
