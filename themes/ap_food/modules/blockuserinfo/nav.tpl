...
<ul id="header_user_info" class="pull-left">
	...
	{else}
		<li class="login hidden-xs hidden-sm">{l s='Welcome visitor you can' mod='blockuserinfo'} 
			<a class="login" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Login to your customer account' mod='blockuserinfo'}"><strong>{l s='login' mod='blockuserinfo'}</strong></a> {l s='or' mod='blockuserinfo'} 
			<a class="login"  href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Create an account' mod='blockuserinfo'}"><strong>{l s='create an account.' mod='blockuserinfo'}</strong></a>
		</li>	
	{/if}
</ul>
