...
<div id="newsletter_block_left" class="block inline">    
    ...
    <div class="block_content">
        ...
        <form action="{$link->getPageLink('index')|escape:'html'}" method="post">
            ...
            <p class="hidden-md hidden-sm hidden-xs">{l s='Stay-up-date with our lastest news. Signup now!' mod='blocknewsletter'}</p>
            ...
            <input type="submit" value="{l s='subscribe' mod='blocknewsletter'}" class="btn btn-inverse" name="submitNewsletter" />
        </form>
        {if isset($msg) && $msg}
