		...
		<fieldset>
			...
			<div id="opc_account_form">
				...
				<p class="required postcode text">
					...
					<input type="tel" class="text" name="postcode" id="postcode" value="{if isset($guestInformations) && $guestInformations.postcode}{$guestInformations.postcode}{/if}" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
				</p>
				...
				<p class="text is_customer_param">
					...
					<input type="tel" class="text" name="phone" id="phone" value="{if isset($guestInformations) && $guestInformations.phone}{$guestInformations.phone}{/if}" />
				</p>
				<p class="{if $one_phone_at_least}required {/if}text">
					...
					<input type="tel" class="text" name="phone_mobile" id="phone_mobile" value="" />
				</p>
				...
				{if !$stateExist}
                   ...
                   <p class="textarea is_customer_param">
					...
					<p class="text">
						...
						<input type="tel" class="text" name="phone_invoice" id="phone_invoice" value="" />
					</p>
					<p class="{if $one_phone_at_least}required {/if}text is_customer_param">
						...
						<input type="tel" class="text" name="phone_mobile_invoice" id="phone_mobile_invoice" value="" />
					</p>
