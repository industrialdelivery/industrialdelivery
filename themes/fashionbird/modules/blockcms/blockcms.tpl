...
{if $display_poweredby}<section class="bottom_footer">&copy; {$smarty.now|date_format:"%Y"} {l s='Designed by' mod='blockcms'} <a target="_blank" href="http://www.devithemes.com">Devil Themes</a></section>{/if}
	<!-- /MODULE Block footer -->
{/if}
