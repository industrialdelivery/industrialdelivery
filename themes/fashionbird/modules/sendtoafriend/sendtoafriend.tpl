...
<div id="sendfriendpage">
	<h1><span>{l s='Send to a friend' mod='sendtoafriend'}</span></h1>
				...
				<fieldset>
					...
					<div id="send_friend_form_content">
						...
						<p class="text">
							...
							<input type="email" id="friend-address" name="email" value="{if isset($smarty.post.name)}{$smarty.post.email|escape:'htmlall'|stripslashes}{/if}" />
						</p>
