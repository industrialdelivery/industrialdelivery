...
<div id="sitemap_content" class="row">
	...
	<div class="sitemap_block titled_box span3">
			<h2><span>{l s='Pages'}</span></h2>
				<ul>
                    <li><a href="{$categoriescmsTree.link}" title="{$categoriescmsTree.name|escape:'htmlall':'UTF-8'}">{$categoriescmsTree.name|escape:'htmlall':'UTF-8'}</a></li>
                        ...
                        {/foreach}
                        <li {if !$display_store} class="last"{/if}><a href="{$link->getPageLink('contact', true)}" title="{l s='Contact'}">{l s='Contact'}</a></li>
