	...
	<div id="pagination" class="pagination">
	  {if $start!=$stop}
		...
		{if $p != 1}
			...
			<li id="pagination_previous"><a class="button" {$no_follow_text} href="{$link->goPage($requestPage, $p_previous)}">{l s='Previous'}</a></li>
		{else}
			<li id="pagination_previous" class="disabled"><span class="button">{l s='Previous'}</span></li>
		{/if}
		{if $start==3}
		...
		{if $pages_nb > 1 AND $p != $pages_nb}
			...
			<li id="pagination_next"><a class="button" {$no_follow_text} href="{$link->goPage($requestPage, $p_next)}">{l s='Next'}</a></li>
		{else}
			<li id="pagination_next" class="disabled"><span class="button">{l s='Next'}</span></li>
		{/if}
		</ul>
	{/if}
