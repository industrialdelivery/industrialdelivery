 ...
 */
if( !class_exists('LeoTwitterParams', false) ){
class LeoTwitterParams{
    ...
    */
	 ...
	 * Constructor
    */
	public function LeoTwitterParams( $current, $name, $configs   ){
		global $cookie;
    ...
    */
    ...
    public function statusTag( $label, $name, $value, $id, $des = '' ){
		$html = '
