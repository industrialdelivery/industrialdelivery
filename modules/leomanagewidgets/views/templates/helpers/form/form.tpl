	...
	<div class="form-group">
					...
					{assign var="t_description" value="description_`$language['iso_code']`"}
						...
						<div class="row">
							<div class="translatable-field lang-{$language.id_lang|escape:'html':'UTF-8'}" {if $language.id_lang != $id_lang_default}style="display:none"{/if}>
								<div class="col-lg-9">
									{/if}
										<textarea id="description_{$language['iso_code']|escape:'html':'UTF-8'}" class="slide_description textarea-autosize" rows="10" cols="40" style="overflow: hidden; word-wrap: break-word; resize: none; height: 199px;" id="description_{$language.iso_code|escape:'html':'UTF-8'}" name="description_{$language.iso_code|escape:'html':'UTF-8'}">{if  $slide_edit && $slide_edit[$t_description]}{$slide_edit[$t_description]}{* HTML form , no escape necessary *}{/if}</textarea>
									{if $languages|count > 1}	
								</div>
								<div class="col-lg-2">
									<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
					 ...
					 {foreach from=$items item=item}
						...
						<div id="contentSlides_{$item.id_slide|escape:'html':'UTF-8'}" class="leo-slide col-lg-12" style="border: 1px solid #ccc;margin-top: 5px;padding: 5px;">
							...
							<div class="col-lg-2">
								...
								<p>
									<a class="btn-edit btn btn-info" href="{$url|escape:'html':'UTF-8'}&id_slide={$item.id_slide|escape:'html':'UTF-8'}" {if $slide_edit && $slide_edit.id_slide && $slide_edit.id_slide == $item.id_slide}style="display:none"{/if}/>{l s='Edit' mod='leomanagewidgets'}</a>
									<input class="btn-delete btn btn-danger" type="button" id="{$item.id_slide|escape:'html':'UTF-8'}" value="{l s='Delete' mod='leomanagewidgets'}">
								</p>
								</div>
							</div>
		...
		{if $input.type == 'setting_tab'}
			...
			{literal}	
				...
				{/literal}{if $tab_edit && $tab_edit.id_tab|escape:'html':'UTF-8'}{literal}
							...
							{if isset($items) && $items}	
							 {foreach from=$items item=item}
								<div id="contentTabs_{$item.id_tab|escape:'html':'UTF-8'}" class="leo-tab col-lg-9" style="border: 1px solid #ccc;margin-top: 5px;padding: 5px;">
									...
									<div class="col-lg-3">{', '|implode:$item.categories|escape:'html':'UTF-8'}</div>
									<div class="col-lg-1">
									...
									<div class="col-lg-2">
										<div class="btn-group-action pull-right">
										<p>
												<a class="btn-edit btn btn-info" href="{$url|escape:'html':'UTF-8'}&id_tab={$item.id_tab|escape:'html':'UTF-8'}" {if $tab_edit && $tab_edit.id_tab && $tab_edit.id_tab == $item.id_tab|escape:'html':'UTF-8'}style="display:none"{/if}/>{l s='Edit' mod='leomanagewidgets'}</a>
											<input class="btn-delete btn btn-danger" type="button" id="{$item.id_tab|escape:'html':'UTF-8'}" value="{l s='Delete' mod='leomanagewidgets'}">
										</p>
										</div>
									</div>
