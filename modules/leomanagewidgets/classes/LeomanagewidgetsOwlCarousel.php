...
if (!class_exists('LeomanagewidgetsOwlCarousel'))
{

	class LeomanagewidgetsOwlCarousel
	{
		...
		public function getOwlCarouselAdminFormOptions()
		{
			return array(
				...
				array(
					...
					'name' => 'owl_autoPlay',
					'default' => 8000,
					'desc' => $this->l('Enter Time(miniseconds) to play carousel carousel. Value 0 to stop.'),
					'form_group_class' => 'carousel_type_sub carousel_type-'.self::CAROUSEL_OWL,
					'class' => 'fixed-width-xl digits',
				),
				array(
